...
public:
	...
	static const std::uint16_t MAP_CHIP_TUTORIALGOAL = 3;
	static const std::uint16_t MAP_CHIP_EASYGOAL = 4;
	static const std::uint16_t MAP_CHIP_DEFAULTGOAL = 5;
	static const std::uint16_t MAP_CHIP_PLAYER_ROTATE_90 = 6;
	static const std::uint16_t MAP_CHIP_PLAYER_ROTATE_180 = 7;
	static const std::uint16_t MAP_CHIP_PLAYER_ROTATE_MIN_90 = 8;
